        ...
        return (
            <div className="row middle col">
                <div className="day col" style={style} onDoubleClick={this.unhideForm}>
                    ...
                    <form stlye={{display: 'none'}} ref='form' onSubmit={this.handleSubmit}>
                        <div className="row">
                            <div className="input-field col">
                                <label>Desc</label>
                                <input ref='desc' type="text" className="text validate" value={this.state.desc} onChange={this.handleChange}></input>
                                </div>
                        </div>
                    </form>
                </div>
